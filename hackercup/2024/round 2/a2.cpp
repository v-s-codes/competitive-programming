      ...
      for(int cnt_2=0;(cnt_2+cnt_1)<k;cnt_2++){
        for(int cnt_3=0;(cnt_3+cnt_2+cnt_1)<k;cnt_3++){
          for(int cnt_4=0;(cnt_4+cnt_3+cnt_2+cnt_1)<k;cnt_4++){
            for(int cnt_5=0;(cnt_5+cnt_4+cnt_3+cnt_2+cnt_1)<k;cnt_5++){
              for(int cnt_6=0;(cnt_6+cnt_5+cnt_4+cnt_3+cnt_2+cnt_1)<k;cnt_6++){
                for(int cnt_7=0;(cnt_7+cnt_6+cnt_5+cnt_4+cnt_3+cnt_2+cnt_1)<k;cnt_7++){
                  int cnt_8=k-(cnt_7+cnt_6+cnt_5+cnt_4+cnt_3+cnt_2+cnt_1);
                  string s="";
